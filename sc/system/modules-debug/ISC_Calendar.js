...
if (window.isc && isc.version != "v11.1p_2017-12-22/LGPL Deployment" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v11.1p_2017-12-22/LGPL Deployment'. Mixing resources from different "
...
// internal stuff - mouse handler
    ...
    rightMouseDown : function () {
        // set this canvas as the drag target on right mouse down
        if (this.dragTarget) this.dragTarget.eventCanvas = this;
    },
