document.write(unescape("%3Cscript src='https://mpbx.a4business.com/assets/js/SIPml-api.js' type='text/javascript'%3E%3C/script%3E"));

//document.write(unescape("%3Cscript src='https://code.jquery.com/jquery-3.3.1.min.js' integrity='sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo' crossorigin='anonymous'%3E%3C/script%3E"));

document.write(unescape("%3Cscript src='//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js'%3E%3C/script%3E"));
document.write(unescape("%3Cscript src='https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js' integrity='sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM' crossorigin='anonymous'%3E%3C/script%3E"));    
document.write(unescape("%3Clink rel='stylesheet' href='https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css' integrity='sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T' crossorigin='anonymous'%3E"));
...
if(c2c.debug){
    c2c.add_html_elts('head',
        [
            { type: 'script', attributes: [{ name: 'type', value: 'text/javascript' }, { name: 'src', value: 'https://mpbx.a4business.com/assets/js/c2c-base64.js' }] },
            { type: 'script', attributes: [{ name: 'type', value: 'text/javascript' }, { name: 'src', value: 'https://mpbx.a4business.com/assets/js/c2c-md5.js' }] }
        ]
    );
}
else{ // release
c2c.add_html_elts('body',
        [
            { type: 'link', attributes: [{ name: 'href', value: 'https://mpbx.a4business.com/assets/css/bootstrap.css' }, { name: 'rel', value: 'stylesheet' }] },
            { type: 'link', attributes: [{ name: 'href', value: 'https://mpbx.a4business.com/assets/css/bootstrap-responsive.css' }, { name: 'rel', value: 'stylesheet' }] }
        ]
    );
}
...
c2c.init = function () {
 ...
 document.write(
        "<a href='#' class='btn btn-large btn-success' id='c2c_btn_call' style=' visibility:hidden;'>call us &raquo;</a>"
    );
    document.write(
    ...
    c2c.button_call.onclick = function () {
        if (!c2c.stack) {
            ...
            websocket_proxy_url = "wss://mpbx.a4business.com:8443/ws";
            sip_outbound_proxy_url  = "SIP://mpbx.a4business.com:5060";
                       
            c2c.stack = new SIPml.Stack({
                   realm: 'mpbx.a4business.com', 
                   impi: c2c.from, 
                   impu: 'sip:' + c2c.from + '@mpbx.a4business.com', 
                   password: c2c.pass,
                    ice_servers: [],
                    /*
                    ice_servers: [
                        {
                            url: "stun:wmc-rtc.host:19302"
                        },
                        {
                            url: "turn:wmc-rtc.host:19302", username: "turn", credential: "secured"
                        },
                        {
                            url: "turns:wmc-rtc.host:19303", username: "turn", 
                            credential: "secured"
                        }
                    ],
                    */
